...
if ([string]::IsNullOrWhiteSpace($BundlePath)) {
    $BundlePath = Join-Path $workspacePath 'outputs\Crownfront-v1.00-code10.aab'
}
...
$summaryPath = Join-Path $workspacePath 'qa-logs\v1.00-code10\qa-summary.json'
...
$versionCodeValid = $manifest.Contains('android:versionCode="10"')
...
[ordered]@{
    ...
    package='com.toykingdom.jellygate'; versionCode=10; sha256=$sha256
