...
if ([string]::IsNullOrWhiteSpace($BundlePath)) {
    $BundlePath = Join-Path $workspacePath 'outputs\Crownfront-v1.00-code9.aab'
}
...
$summaryPath = Join-Path $workspacePath 'qa-logs\v1.00-code9\qa-summary.json'
...
$versionCodeValid = $manifest.Contains('android:versionCode="9"')
...
[ordered]@{
    ...
    package='com.toykingdom.jellygate'; versionCode=9; sha256=$sha256
