...
if ([string]::IsNullOrWhiteSpace($BundlePath)) {
    $BundlePath = Join-Path $workspacePath 'outputs\Crownfront-v1.00-code12.aab'
}
...
$summaryPath = Join-Path $workspacePath 'qa-logs\v1.00-code12\play-bundle-summary.json'
...
$versionCodeValid = $manifest.Contains('android:versionCode="12"')
...
[ordered]@{
    ...
    package='com.toykingdom.jellygate'; versionCode=12; sha256=$sha256
