...
if ([string]::IsNullOrWhiteSpace($BundlePath)) {
    $BundlePath = Join-Path $workspacePath 'outputs\Crownfront-v1.00-code25.aab'
}
...
$summaryPath = Join-Path $workspacePath 'qa-logs\v1.00-code25\play-bundle-summary.json'
...
$versionCodeValid = $manifest.Contains('android:versionCode="25"')
...
[ordered]@{
    ...
    package='com.toykingdom.jellygate'; versionCode=25; sha256=$sha256
