...
if ([string]::IsNullOrWhiteSpace($BundlePath)) {
    $BundlePath = Join-Path $workspacePath 'outputs\Crownfront-v1.00-code18.aab'
}
...
$summaryPath = Join-Path $workspacePath 'qa-logs\v1.00-code18\play-bundle-summary.json'
...
$versionCodeValid = $manifest.Contains('android:versionCode="18"')
...
[ordered]@{
    ...
    package='com.toykingdom.jellygate'; versionCode=18; sha256=$sha256
