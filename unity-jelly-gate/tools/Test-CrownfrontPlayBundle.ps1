...
if ([string]::IsNullOrWhiteSpace($BundlePath)) {
    $BundlePath = Join-Path $workspacePath 'outputs\Crownfront-v1.00-code5.aab'
}
...
$summaryPath = Join-Path $workspacePath 'qa-logs\v1.00-code5\qa-summary.json'
...
$versionCodeValid = $manifest.Contains('android:versionCode="5"')
...
[ordered]@{
    ...
    package='com.toykingdom.jellygate'; versionCode=5; sha256=$sha256
