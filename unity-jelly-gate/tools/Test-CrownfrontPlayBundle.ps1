...
if ([string]::IsNullOrWhiteSpace($BundlePath)) {
    $BundlePath = Join-Path $workspacePath 'outputs\Crownfront-v1.00-code26.aab'
}
...
$summaryPath = Join-Path $workspacePath 'qa-logs\v1.00-code26\play-bundle-summary.json'
...
$versionCodeValid = $manifest.Contains('android:versionCode="26"')
...
[ordered]@{
    ...
    package='com.toykingdom.jellygate'; versionCode=26; sha256=$sha256
