...
if ([string]::IsNullOrWhiteSpace($BundlePath)) {
    $BundlePath = Join-Path $workspacePath 'outputs\Crownfront-v1.00-code24.aab'
}
...
$summaryPath = Join-Path $workspacePath 'qa-logs\v1.00-code24\play-bundle-summary.json'
...
$versionCodeValid = $manifest.Contains('android:versionCode="24"')
...
[ordered]@{
    ...
    package='com.toykingdom.jellygate'; versionCode=24; sha256=$sha256
