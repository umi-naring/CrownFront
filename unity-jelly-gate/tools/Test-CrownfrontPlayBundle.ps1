...
if ([string]::IsNullOrWhiteSpace($BundlePath)) {
    $BundlePath = Join-Path $workspacePath 'outputs\Crownfront-v1.00-code17.aab'
}
...
$summaryPath = Join-Path $workspacePath 'qa-logs\v1.00-code17\play-bundle-summary.json'
...
$versionCodeValid = $manifest.Contains('android:versionCode="17"')
...
[ordered]@{
    ...
    package='com.toykingdom.jellygate'; versionCode=17; sha256=$sha256
