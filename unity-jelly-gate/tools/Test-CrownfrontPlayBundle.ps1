...
if ([string]::IsNullOrWhiteSpace($BundlePath)) {
    $BundlePath = Join-Path $workspacePath 'outputs\Crownfront-v1.00-code8.aab'
}
...
$summaryPath = Join-Path $workspacePath 'qa-logs\v1.00-code8\qa-summary.json'
...
$versionCodeValid = $manifest.Contains('android:versionCode="8"')
...
[ordered]@{
    ...
    package='com.toykingdom.jellygate'; versionCode=8; sha256=$sha256
