...
if ([string]::IsNullOrWhiteSpace($BundlePath)) {
    $BundlePath = Join-Path $workspacePath 'outputs\Crownfront-v1.00-code11.aab'
}
...
$summaryPath = Join-Path $workspacePath 'qa-logs\v1.00-code11\play-bundle-summary.json'
...
$versionCodeValid = $manifest.Contains('android:versionCode="11"')
...
[ordered]@{
    ...
    package='com.toykingdom.jellygate'; versionCode=11; sha256=$sha256
